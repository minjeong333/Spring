...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		// 문제  ) output price가 가장 높은 순으로 정렬 후 출력하기		Comparable 인터페이스 구현하는 방법
		models.stream().sorted().forEach(item -> System.out.println(item));
		...
		models.stream().sorted( (o1, o2) -> {return o1.getName().compareTo(o2.getName()); }).forEach(item -> System.out.println(item));
	}
